...
$Id: README.txt 4759 2014-01-23 07:42:48Z mshafae $

Summary

`hello_glut' is a demonstration program that renders a colored tetrahedron that rotates around the X, Y, and Z axis to make it appear as though it is wobbling. It is drawn twice. First it is drawn as a colored triangle strip and then drawn as a collection of black lines.
...
To run the program, run `hello_glut'. It does not require any command line options.
